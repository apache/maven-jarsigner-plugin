...
* Usage
  ...
  specific use cases are described in the examples given below. Additionally, users can contribute to the
  {{{https://github.com/apache/maven-jarsigner-plugin}GitHub project}}.
